          ...
          className
            ...
            <div className='flex items-center gap-2 ml-auto'>
                ...
                <Sheet>
                    ...
                    <SheetContent className='overflow-scroll mt-4 no-scrollbar mr-4 pr-4'>
                        ...
                        {allNotifications?.map((notification) =>(
                            <div key={notification.id} className='flex flex-col gap-y-2 mb-2 overflow-x-scroll text-ellipsis no-scrollbar mt-3'>
