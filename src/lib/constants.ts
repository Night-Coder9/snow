...
import ClipboardIcon from '@/components/icons/clipboardIcons'
...
import PluraCategory from '@/components/icons/snow_category'
import Power from '@/components/icons/power'
import Receipt from '@/components/icons/receipts'
...
export const pricingCards = [
    {
      title: 'Starter',
      description: 'Perfect for trying out snow',
      price: 'Free',
      duration: '',
    ...
    },
    {
      ...
      priceId: 'price_1OqGpPSBcvXzdj6rt1xYpPGd',
    },
    {
      title: 'Basic',
      ...
      priceId: 'price_1OqGpQSBcvXzdj6rLU8wHyxu',
    },
  ]

  export const addOnProducts = [
    {title: 'Priority Support' , id: 'prod_PfcIjXJZiPK10w'}
  ]
