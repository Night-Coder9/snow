...
const PricingCard = ({features, buttonCta, title, description, amt, duration, highlightDescription, customerId, planExists, prices, highlightTitle}: Props) => {
  ...
  return (
    <Card className='flex flex-col justify-center lg:w-1/2'>
        <div>
