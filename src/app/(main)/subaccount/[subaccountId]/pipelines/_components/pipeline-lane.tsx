  ...
  return (
    ...
    >
      {(provided, snapshot) => {
        ...
        console.log(`Rendering Draggable Lane with ID: ${laneDetails.id}`);
        return (
          <div
          ...
          >
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-slate-200/30 dark:bg-background/20  h-[700px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0 no-scrollbar">
                  <div
                  ...
                  >
                    {(provided) => (
                      <div className=" max-h-[700px] overflow-scroll pt-12 no-scrollbar">
                        <div
